  ...
  return (
    <div>
        ...
        <div className='flex flex-wrap container m-auto justify-between mt-12'>
            <div className='bg-gradient-to-r from-blue-700 to-blue-900 flex flex-col w-2/5 p-6 mb-10 border rounded-lg cursor-pointer shadow-md transform transition-transform hover:scale-105'>
                <h3 className='font-bold text-2xl text-center mb-4 text-white'>Sesión Pre-Boda</h3>
                ...
                <p className='bg-blue-900 text-white px-4 py-2 rounded-full inline-block mb-2'>Precio: <span className='font-bold'>$1,000 RD</span></p>
            </div>
            <div className='bg-gradient-to-r from-blue-700 to-blue-900 flex flex-col w-2/5 p-6 mb-10 border rounded-lg cursor-pointer shadow-md transform transition-transform hover:scale-105'>
              <h3 className='font-bold text-2xl text-center mb-4 text-white'>Sesión Pre-Boda</h3>
              <p className='text-justify mb-4 text-white'>
